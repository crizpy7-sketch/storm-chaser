# Storm Chaser v0.10.1 — Validation

72 checkpoint checks pass, including all three movies, mission freezing, audio restoration, safe skips, decoder fallbacks, duplicate-finish protection, save/retry, the new replay unlock, gallery pagination, persistence and earlier-save migration. The curves movie is explicitly checked to continue beyond the old 2.8-second preview deadline, preserve the supplied aspect ratio, and fall back to the road rather than a warehouse scene.
...
The short release preview shows the movie in the exported Linux game, its natural completion, level-four driving and the unlocked gallery. The supplied movie is prerecorded Grok footage; the driving segment is actual Godot gameplay. Offline capture does not measure device performance.
